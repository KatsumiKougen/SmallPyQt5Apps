...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.FileView_TreeView = QtWidgets.QTreeView(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.FileView_TreeView.sizePolicy().hasHeightForWidth())
        self.FileView_TreeView.setSizePolicy(sizePolicy)
        self.FileView_TreeView.setObjectName("FileView_TreeView")
        self.FileViewLayout.addWidget(self.FileView_TreeView)
        ...
        self.TextEditor_Tab0 = QtWidgets.QWidget()
        self.TextEditor_Tab0.setObjectName("TextEditor_Tab0")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.TextEditor_Tab0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.TextEditor_MainWidget = QtWidgets.QPlainTextEdit(self.TextEditor_Tab0)
        font = QtGui.QFont()
        ...
        self.verticalLayout.addWidget(self.TextEditor_MainWidget)
        self.TextEditorTabs.addTab(self.TextEditor_Tab0, "")
        self.TextEditorLayout.addWidget(self.TextEditorTabs)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.CWD_Button.setText(_translate("MainWindow", "Change"))
        self.TextEditorTabs.setTabText(self.TextEditorTabs.indexOf(self.TextEditor_Tab0), _translate("MainWindow", "Tab 1"))
