...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Status_SplashLabel = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Status_SplashLabel.sizePolicy().hasHeightForWidth())
        self.Status_SplashLabel.setSizePolicy(sizePolicy)
        self.Status_SplashLabel.setTextFormat(QtCore.Qt.RichText)
        self.Status_SplashLabel.setObjectName("Status_SplashLabel")
        self.StatusLayout.addWidget(self.Status_SplashLabel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Status_SplashLabel.setText(_translate("MainWindow", "<html><head/><body><p>[<span style=\" font-family:\'monospace\'; color:#ffff00; background-color:#000000;\">HAHAHA! Like &quot;Ay, wake yo sleepy head up!&quot;</span>]</p></body></html>"))
